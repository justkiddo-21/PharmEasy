package com.huit.pharmeasy.adapter;
...
import com.huit.pharmeasy.activity.BaseActivity;
import com.huit.pharmeasy.activity.ProductViewActivity;
import com.huit.pharmeasy.interfaces.AddorRemoveCallbacks;
import com.huit.pharmeasy.model.Cart;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.subTotal.setText(total_item + "X" + _price + "= VND" + _subtotal);
                ...
                if (cartList.size() == 0 || pQuantity == 0) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                            ...
                            holder.subTotal.setText(total_item + "X" + holder.price.getText().toString() + "= VND" + _subtotal);
                            String cartStr = gson.toJson(cartList);
                            //Log.d("CART", cartStr);
                            localStorage.setCart(cartStr);
                            notifyItemChanged(position);
